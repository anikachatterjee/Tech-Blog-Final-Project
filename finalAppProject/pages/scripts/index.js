...
function renderLog(doc) {
    ...
    let jerseyNum = document.createElement('span');
    ...
    sport.textContent = doc.data().sport;
    jerseyNum.textContent = doc.data().jerseyNum;
    ...
    jerseyNum.classList = 'logLI';
   
    li.appendChild(name);
    li.appendChild(jerseyNum);
